...
public class RealSwerveModuleConstants extends SwerveModuleConstants {
    private static final double WHEEL_DIAMETER_METERS = 0.049149 * 2;
    ...
    private static TalonFXConfiguration generateDriveConfiguration() {
        ...
        config.Feedback.SensorToMechanismRatio = SwerveModuleConstants.DRIVE_GEAR_RATIO;
    ...
    private static TalonFXConfiguration generateSteerConfiguration() {
        ...
        config.Feedback.SensorToMechanismRatio = SwerveModuleConstants.STEER_GEAR_RATIO;
