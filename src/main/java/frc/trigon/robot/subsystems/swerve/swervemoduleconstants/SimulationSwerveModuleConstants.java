...
public class SimulationSwerveModuleConstants extends SwerveModuleConstants {
    ...
    public static final MotorPhysicsSimulation
            DRIVE_SIMULATION = new SimpleMotorSimulation(DRIVE_MOTOR_GEARBOX, SwerveModuleConstants.DRIVE_GEAR_RATIO, DRIVE_MOMENT_OF_INERTIA),
            STEER_SIMULATION = new SimpleMotorSimulation(STEER_MOTOR_GEARBOX, SwerveModuleConstants.STEER_GEAR_RATIO, STEER_MOMENT_OF_INERTIA);
